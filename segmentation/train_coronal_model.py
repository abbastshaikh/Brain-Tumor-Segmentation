...
from datagenerator import CoronalGenerator
...
training_generator = CoronalGenerator(train_ids, mount)
validation_generator = CoronalGenerator(validation_ids, mount)
...
keras_callbacks = [
    ...
    ModelCheckpoint('wasp_net_coronal-{epoch:02d}.h5', save_best_only=False)]
