...
from datagenerator import SaggitalGenerator
from models import wasp_net
...
training_generator = SaggitalGenerator(train_ids, mount)
validation_generator = SaggitalGenerator(validation_ids, mount)


dims = (240, 160, 1)
model = wasp_net((240, 160, 1))
...
keras_callbacks = [
    ...
    ModelCheckpoint('wasp_net_saggital-{epoch:02d}.h5', save_best_only=False)]
